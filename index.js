...
const {k_name,k_color,song_2,song_4,k_job,k_partner}= k_muppet.k_album.the_muppet_movie;
console.log(k_color,song_2,song_4,k_job,k_partner);

const {k_name,k_color,k_job,k_partner}= k_muppet.k_album.the_muppet_movie;
